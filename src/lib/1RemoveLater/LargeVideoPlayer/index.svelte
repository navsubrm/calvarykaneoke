...
>
	...
	<div class="content">
		...
		<div class="video-footer">
			<button class="button">SEND POSTCARD</button>
		...
		<div class="flex-content">
			...
			<div class="content_text">
				<p>
					ADMIT THAT YOU’RE A SINNER. This is where that godly sorrow leads to genuine repentance
					for sinning against the righteous God and there is a change of heart, we change our mind
					and God changes our hearts and regenerates us from the inside out.
				</p>
			</div>
		</div>
		<div class="flex-content">
			...
			<div class="content_text">
				<p>
					BELIEVE IN YOUR HEART THAT JESUS CHRIST DIED FOR YOUR SINS, WAS BURIED, AND THAT GOD
					RAISED JESUS FROM THE DEAD. Believe in your heart that Jesus Christ died for your sins,
					was buried, and that God raised Jesus from the dead. This is trusting with all of your
					heart that Jesus Christ is who he said he was.
				</p>
			</div>
		</div>
		<div class="flex-content">
			...
			<div class="content_text">
				<p>
					CALL UPON THE NAME OF THE LORD. This is trusting with all of your heart that Jesus Christ
					is who he said he was. Every single person who ever lived since Adam will bend their knee
					and confess with their mouth that Jesus Christ is Lord, the Lord of Lords and the King of
					Kings.
				</p>
			</div>
		</div>
