...
<section style="--_background-img: url({data?.background_image_url});">
	<div class="main-content">
		...
		{#if data?.sub_title_left && data?.sub_title_right}
			<div class="sub-title">
				<GeneralContentBlock data={data?.sub_title_left} classes={'sub-title-a'} />
				<GeneralContentBlock data={data?.sub_title_right} classes={'sub-title-b'} />
			</div>
		{/if}
	</div>
	<ChevronAnimation />
...
<style>
	...
	.sub-title :global(.sub-title-a),
	.sub-title :global(.sub-title-b) {
		display: flex;
